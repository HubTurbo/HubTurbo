...
public class PanelRenameTest extends UITest {
    ...
    public void panelRenameTest() {
        ...
        pushKeys(CREATE_RIGHT_PANEL);
        String panelCloseButtonId = IdGenerator.getPanelCloseButtonIdForTest("dummy/dummy", 3);
        String panelRenameTextFieldId =  IdGenerator.getPanelRenameTextFieldIdForTest("dummy/dummy", 3);
        String panelNameAreaId = IdGenerator.getPanelNameAreaIdForTest("dummy/dummy", 3);
        ...
        click(IdGenerator.getOcticonButtonIdForTest("dummy/dummy", 4, "confirmButton"));
        ...
        click(IdGenerator.getOcticonButtonIdForTest("dummy/dummy", 5, "undoButton"));
