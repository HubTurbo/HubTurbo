...
public class BoardTests extends UITest {
    ...
    public void boardSaveAs() {
        ...
        waitAndAssert(1, panelControl::getNumberOfSavedBoards);
    ...
    private static String uiTitleWithBoard(String boardName) {
        String version = Utility.version(UI.VERSION_MAJOR, UI.VERSION_MINOR, UI.VERSION_PATCH);
        return String.format("HubTurbo %s (%s)", version, boardName);
    }
}
