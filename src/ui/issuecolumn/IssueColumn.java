...
/**
 * An IssueColumn is a Column meant for containing issues.
 * The main additions to Column are filtering functionality.
 * The IssueColumn does not specify how the list is to be displayed
 *  -- that is the job of its subclasses.
 */
