...
![](images/gettingStarted/bothViewsScreenshot.png?raw=true)
...
Before you start using HubTurbo features, you may want to check out [the basics of navigating GitHub using HubTurbo](uiBasics.md).
