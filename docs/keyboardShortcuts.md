...
|n<sup>th</sup> issue (from *1* to *9*)| <kbd>Ctrl</kbd> + <kbd>n</kbd>| If the focus is on the issue list, jumps to nth issue, where n is the issue number ranging from 1 (at the top of the list) to 9|
