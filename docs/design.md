...
- **UI**, **Util**, **Backend**, **TestDriver** : self explanatory.
...
Updater handles updating of application, including updating the JAR and restarting of application once download of update
is done.